...
- 最優先: 2seed評価で見えた死亡/不安定さを潰す。`0x2f52869f` のImitationAI死亡frame 1470、`0x13579bdf` のImitationAI star 0 / approach悪化、RuleAIのdeath 2 seedをSVG/viewerで確認し、hazard相対速度、着地予測、壁詰まり時の切り返し、RuleAIのhazard回避を改善する。その後 `run-nsmb-mvl-ai-closed-loop-batch.ps1` でseed数を3-5本へ増やす。
