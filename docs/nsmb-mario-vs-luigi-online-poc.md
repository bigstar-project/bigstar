...
- Latest delay-2 exact-ish Main RAM delta experiment:
  ...
  - Latest JIT reset experiments:
    ...
    - Same-frame waits and larger Main RAM delta pages are not fixes under the delay2 rule. `skipjit-rbwait250/500-cp1` did not reduce over33 enough and worsened average timing; `skipjit-page512-cp1` and `skipjit-page1024-cp1` both mismatched contact in `logs/rb-skipjit-pagesize-sweep/20260622-191452`.
