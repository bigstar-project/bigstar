...
- 2026-06-23 continuation after skip-restored-JIT validation:
  ...
  - Current blocker remains structural: after removing the restored-range JIT invalidation cliff, exact rollback still pays restore plus a resimulated `RunFrame` inside the displayed frame. Small waits can trade spikes for worse average FPS, but they do not reach stable 60fps.
