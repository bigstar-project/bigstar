...
- 2026-06-23 stats/spike-classification continuation:
  ...
  - Rejected in this pass: `consume-current-frame`, `maxLead2`, `maxLead2+rbwait1000`, leadbudget `4/6ms`, no lead limit, and `rbwait750`. They either increased correction frequency, increased remote waits, or worsened average FPS.
