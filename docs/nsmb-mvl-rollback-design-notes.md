...
This section records the 2026-06-02 Plan-D experiment. It was not promoted to the production correctness route. As of 2026-07-15, the unused item-specific client-spawn branch described below has been removed; the Big Star, moving-hazard, effect, and generic actor snapshots remain under separate review.
