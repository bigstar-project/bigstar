...
- 2026-06-23 continuation after skip-restored-JIT validation:
  ...
  - Current conclusion: the best exact-ish oracle is now small enough to expose the real architectural issue. Stable 60fps with delay2 needs either non-blocking/shadow correction or a correct selected lifecycle snapshot; more checkpoint slimming, final-checkpoint skipping, or micro-waits are not sufficient.
