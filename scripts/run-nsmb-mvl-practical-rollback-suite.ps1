...
function Get-PersistentShadowFields {
    param([string]$Path)
    ...
    $line = Get-LastLineMatching -Path $Path -Pattern "NSMB PersistentShadow: summary"
    if (-not $line) {
        return $result
    }
    ...
    foreach ($key in @(
        ...
        if ($line -match "$key=([0-9.]+)") {
            switch ($key) {
                "enqueued" { $result.Enqueued = $Matches[1] }
                "completed" { $result.Completed = $Matches[1] }
                "dropped" { $result.Dropped = $Matches[1] }
                "continuous" { $result.Continuous = $Matches[1] }
                "continuousInvalid" { $result.ContinuousInvalid = $Matches[1] }
                "continuityErrors" { $result.ContinuityErrors = $Matches[1] }
                "latestLag" { $result.LatestLag = $Matches[1] }
                "maxLag" { $result.MaxLag = $Matches[1] }
                "enqueueAvgUs" { $result.EnqueueAvgUs = $Matches[1] }
                "enqueueMaxUs" { $result.EnqueueMaxUs = $Matches[1] }
                "restoreAvgUs" { $result.RestoreAvgUs = $Matches[1] }
                "restoreMaxUs" { $result.RestoreMaxUs = $Matches[1] }
                "runAvgUs" { $result.RunAvgUs = $Matches[1] }
                "runMaxUs" { $result.RunMaxUs = $Matches[1] }
                "compared" { $result.Compared = $Matches[1] }
                "match" { $result.Match = $Matches[1] }
                "differingBytes" { $result.DifferingBytes = $Matches[1] }
            }
        }
    }
    return $result
...
$candidateDefs = @{
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition0-staractivate-pred0" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition0-staractivate-fresh-pred0" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition0-staractivate-playerpred1" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition0-staractivate-playerpred2" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred2" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM_START_OFFSET = "0"
            MELONDS_NSML_PLAYER_STATE_MAX_STALE_GLOBAL_FRAMES = "12"
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred2-reliableplayer" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred2-reliableglobal" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_ON_GLOBAL_CHANGE = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred2-reliablekf30" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred4-reliablekf30" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred4-reliablekf30-hazardlife" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hazardlife" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-dynpred" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            ...
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM_START_OFFSET = "0"
            MELONDS_NSML_PLAYER_STATE_MAX_STALE_GLOBAL_FRAMES = "12"
            MELONDS_NSML_PLAYER_STATE_ZERO_PREDICT_DURING_TRANSITION = "1"
        }
    }
    "pland-p4-kf30-hz-dynpred-redeath" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_REAPPLY_OVERWRITTEN_GLOBALS = "1"
            MELONDS_NSML_PLAYER_STATE_REAPPLY_DEATH_TRANSITION_GLOBALS_ONLY = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hz-dynpred-redeath-hztrace" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            ...
            MELONDS_NSML_STATE_SYNC_SAMPLE_WORD_DIFF = "1"
            MELONDS_NSML_WORLD_STATE_TRACE_OBJECT_LIFECYCLES = "1"
            MELONDS_NSML_WORLD_STATE_TRACE_OBJECT_LIFECYCLES_INTERVAL = "30"
            MELONDS_NSML_WORLD_STATE_TRACE_OBJECT_LIFECYCLES_START_FRAME = "3600"
            MELONDS_NSML_WORLD_STATE_TRACE_OBJECT_LIFECYCLES_END_FRAME = "4080"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM_START_OFFSET = "0"
            MELONDS_NSML_PLAYER_STATE_MAX_STALE_GLOBAL_FRAMES = "12"
            MELONDS_NSML_PLAYER_STATE_ZERO_PREDICT_DURING_TRANSITION = "1"
    ...
    "pland-p4-kf30-hz-dynpred-redeath-worldfresh" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-dynpred-redeath-hzspawn" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-dynpred-redeath-keepactors" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p2-kf30-hazardlife" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p0-kf30-hazardlife" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p1-kf30-hazardlife" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p0-kf30-hzspawn" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-reglobal" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-recrit" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_REAPPLY_OVERWRITTEN_GLOBALS = "1"
            MELONDS_NSML_PLAYER_STATE_REAPPLY_CRITICAL_GLOBALS_ONLY = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hz-localtrans" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_TREAT_TRANSITION_STATUS_LOCAL = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hz-localtrans-reglobal" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-dynpred-localtrans-redeath" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-pfresh1000" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_FRESH_WAIT_US = "1000"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hazardlife-trace" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_INPUT_TRACE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_APPLY_TRACE = "1"
            MELONDS_NSML_PLAYER_STATE_APPLY_TRACE_START_FRAME = "800"
            MELONDS_NSML_PLAYER_STATE_APPLY_TRACE_END_FRAME = "4200"
            MELONDS_NSML_STATE_SYNC_SAMPLE_WORD_DIFF = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hz-pfresh750" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_FRESH_WAIT_US = "750"
            MELONDS_NSML_WORLD_STATE_APPLY_MVL_STAGE_LAYOUT_GATES = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hz-pfresh750-gates-worddiff" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-pfresh750-hzspawn" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-pfresh750-hztrace" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-pfresh1500" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL = "30"
            MELONDS_NSML_PLAYER_STATE_FRESH_WAIT_US = "1500"
            MELONDS_NSML_WORLD_STATE_APPLY_MVL_STAGE_LAYOUT_GATES = "1"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "pland-p4-kf30-hz-pfresh1500-gates-worddiff" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p4-kf30-hz-pfresh1500-gates-worddiff-hzrelink" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            ...
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_MOVING_HAZARD = "1"
            MELONDS_NSML_WORLD_STATE_RESTORE_MOVING_HAZARD_LAST_BASE = "1"
            MELONDS_NSML_WORLD_STATE_RELINK_MOVING_HAZARD_PROCESS_LISTS = "1"
            MELONDS_NSML_WORLD_STATE_CLEAR_MOVING_HAZARD_LINK_FIELDS = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM_START_OFFSET = "0"
            MELONDS_NSML_PLAYER_STATE_MAX_STALE_GLOBAL_FRAMES = "12"
    ...
    "pland-p0-kf30-hz-pfresh1500-gates-worddiff" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "pland-p0-kf30-hz-pfresh1500-gates-worddiff-hzfreeze" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            ...
            MELONDS_NSML_WORLD_STATE_RESTORE_MOVING_HAZARD_LAST_BASE = "1"
            MELONDS_NSML_WORLD_STATE_CLEAR_MOVING_HAZARD_LINK_FIELDS = "1"
            MELONDS_NSML_WORLD_STATE_FREEZE_LOCAL_MOVING_HAZARD_UPDATE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_MOVING_HAZARD = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_MOVING_HAZARD_DELAY_FRAMES = "90"
            MELONDS_NSML_WORLD_STATE_MOVING_HAZARD_MAX_STALE_FRESH_FRAMES = "4"
            MELONDS_NSML_WORLD_STATE_STAR_CANDIDATE_DEEP_SCAN_INTERVAL = "30"
            MELONDS_NSML_WORLD_STATE_STAR_CANDIDATE_FRESH_WAIT_US = "100"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM_START_OFFSET = "0"
            MELONDS_NSML_PLAYER_STATE_MAX_STALE_GLOBAL_FRAMES = "12"
            MELONDS_NSML_PLAYER_STATE_ZERO_PREDICT_DURING_TRANSITION = "1"
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred2-reliableglobal-kf30" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-pruneabsentstar-transition0-staractivate-playerpred2-statefresh250" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_STATE_APPLY_FRESH_WAIT_US = "250"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition0-starspawnactivate-pred0" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition90-starspawnactivate-pred0" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition90-staractivate-statefresh500-pred0" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_STATE_APPLY_FRESH_WAIT_US = "500"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM = "1"
    ...
    "predictrepair-delay2-player-world-actorsnap32-lifecycle-prune-transition90-staractivate-statefresh1000-pred0" = [pscustomobject]@{
        Backend = "tinycorepreimage"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
        ...
        Env = @{
            MELONDS_NSML_STATE_APPLY_FRESH_WAIT_US = "1000"
            MELONDS_NSML_WORLD_STATE_APPLY_ACTOR_SNAPSHOT_LIFECYCLE = "1"
            MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_ACTOR_SNAPSHOT = "1"
            MELONDS_NSML_WORLD_STATE_ACTIVATE_DORMANT_ACTOR_SNAPSHOT_STAR_CANDIDATE = "1"
            MELONDS_NSML_PLAYER_STATE_TRANSITION_TRANSFORM = "1"
    ...
    "nsmbtc-rb1500-mr2-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 1500
        RollbackMaxResimFrames = 2
    ...
    "nsmbtc-rb2000-mr2-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 2000
        RollbackMaxResimFrames = 2
    ...
    "nsmbtc-rb1000-mr1-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 1000
        RollbackMaxResimFrames = 1
    ...
    "nsmbtc-rb0-mr1-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "nsmbtc-rb500-mr2-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 500
        RollbackMaxResimFrames = 2
    ...
    "nsmbtc-rb0-mr2-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "nsmbtc-rb0-mr2-limit2-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "nsmbtc-rb1000-mr2-delay1-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 1000
        RollbackMaxResimFrames = 2
    ...
    "nsmbtc-rb0-mr5-lead6-budget2ms-noskipjit-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM = "1"
            MELONDS_NSML_ROLLBACK_ADAPTIVE_CHECKPOINT_CRITICAL_INTERVAL = "2"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive3-prescratch-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM_INTERVAL = "2"
            MELONDS_NSML_ROLLBACK_ADAPTIVE_CHECKPOINT_CRITICAL_INTERVAL = "2"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch3-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM_INTERVAL = "3"
            MELONDS_NSML_ROLLBACK_ADAPTIVE_CHECKPOINT_CRITICAL_INTERVAL = "2"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch3-shadowprobe-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
            MELONDS_NSML_PERSISTENT_SHADOW_PROBE = "1"
            MELONDS_NSML_PERSISTENT_SHADOW_START_FRAME = "900"
            MELONDS_NSML_PERSISTENT_SHADOW_END_FRAME = "1500"
            MELONDS_NSML_PERSISTENT_SHADOW_COMPARE_FRAME = "1500"
            MELONDS_NSML_PERSISTENT_SHADOW_MAX_QUEUE = "180"
            MELONDS_NSML_PERSISTENT_SHADOW_SUMMARY_DRAIN_MS = "3000"
        }
    }
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch3-shadowcont-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
            MELONDS_NSML_PERSISTENT_SHADOW_PROBE = "1"
            MELONDS_NSML_PERSISTENT_SHADOW_CONTINUOUS = "1"
            MELONDS_NSML_PERSISTENT_SHADOW_START_FRAME = "900"
            MELONDS_NSML_PERSISTENT_SHADOW_END_FRAME = "1500"
            MELONDS_NSML_PERSISTENT_SHADOW_COMPARE_FRAME = "1499"
            MELONDS_NSML_PERSISTENT_SHADOW_MAX_QUEUE = "1024"
            MELONDS_NSML_PERSISTENT_SHADOW_SUMMARY_DRAIN_MS = "3000"
        }
    }
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch3-consume-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch4-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM_INTERVAL = "4"
            MELONDS_NSML_ROLLBACK_ADAPTIVE_CHECKPOINT_CRITICAL_INTERVAL = "2"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch6-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM = "1"
            MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM_INTERVAL = "6"
            MELONDS_NSML_ROLLBACK_ADAPTIVE_CHECKPOINT_CRITICAL_INTERVAL = "2"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
    ...
    "nsmbtc-rb0-mr5-lead6-budget2ms-lookupjit-limit1-cp12-adaptive2-prescratch-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 5
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit2-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-uncapped-lead6-budget2ms-lookupjit-limit2-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 0
    ...
    "nsmbtc-rb0-mr8-lead6-budget2ms-lookupjit-limit2-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr10-lead6-budget2ms-lookupjit-limit2-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
        RollbackResimulate = $true
        RollbackPredictOnly = $false
        RollbackSkipRenderDuringResim = $true
        RollbackTinyCoreFlags = "0x27D"
    ...
    "nsmbtc-rb0-mr10-lead4-budget2ms-lookupjit-limit2-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr10-lead2-budget2ms-lookupjit-limit2-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr10-lead6-budget2ms-lookupjit-limit4-cp2-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "4"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ACTOR_ARENA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ARM9_STACK_RANGE = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
    ...
    "nsmbtc-rb0-mr10-lead6-budget2ms-lookupjit-limit2-cp2-skipmidcp-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr10-lead2-budget2ms-lookupjit-limit2-cp2-skipmidcp-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr10-lead2-skippredthrottle-budget2ms-lookupjit-limit2-cp2-skipmidcp-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr10-lead2-skippredthrottle-budget2ms-lookupjit-limit1-cp2-skipmidcp-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr10-lead2-pendingthrottle-budget2ms-lookupjit-limit2-cp2-skipmidcp-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_SKIP_PREDICTED_FRAME_LEAD_THROTTLE = "1"
            MELONDS_NSML_ROLLBACK_THROTTLE_PREDICTED_ONLY_WHEN_PENDING = "1"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "2"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ACTOR_ARENA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ARM9_STACK_RANGE = "1"
    ...
    "nsmbtc-rb0-mr10-lead6-budget2ms-lookupjit-limit2-cp2-prepump-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 10
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit2-cp2-startwait16ms90-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "2000"
            MELONDS_NSML_ROLLBACK_STARTUP_INPUT_WAIT_US = "16000"
            MELONDS_NSML_ROLLBACK_STARTUP_INPUT_WAIT_FRAMES = "90"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "2"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ACTOR_ARENA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ARM9_STACK_RANGE = "1"
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit2-cp2-future6hold-confirmedstate-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_INPUT_BUNDLE_FUTURE = "6"
    ...
    "trace-nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit2-cp2-confirmedstate-inputtrace-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-arena-stack-heap60-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-arena-stack-heap15-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr6-lead6-budget2ms-lookupjit-limit1-widearena10000-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rbwait500-mr6-lead6-budget2ms-lookupjit-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 500
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rbwait1000-mr6-lead6-budget2ms-lookupjit-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 1000
        RollbackMaxResimFrames = 6
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-delta-playerc80-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-safe-fields-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr8-lead6-budget2ms-lookupjit-limit1-proclist-safe-fields-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-meta-safe-fields-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_METADATA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "0"
            MELONDS_NSML_ROLLBACK_NSMB_SAFE_OBJECT_FIELD_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
    ...
    "nsmbtc-rb0-mr8-lead6-budget2ms-lookupjit-limit1-proclist-meta-safe-fields-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-safe-fields-heap15-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-safe-fields-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_INTERVAL = "15"
            MELONDS_NSML_ROLLBACK_NSMB_SAFE_OBJECT_FIELD_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x021B5C00+0x400;0x021B6C00+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
        }
    }
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_INTERVAL = "15"
            MELONDS_NSML_ROLLBACK_NSMB_SAFE_OBJECT_FIELD_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0xC80"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x021B5C00+0x400;0x021B6C00+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
    ...
    "nsmbtc-rb0-mr4-lead0-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead1-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-cp2-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-cp2crit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core241" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-nothrottle-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget500us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "500"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
    ...
    "nsmbtc-rb0-mr4-lead2-budget1000us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget1500us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1500"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
    ...
    "nsmbtc-rb0-mr4-lead2-budget1750us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1750"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
    ...
    "trace-nsmbtc-rb0-mr4-lead2-budget1750us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249-worddiff" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "trace-nsmbtc-rb0-mr4-lead2-budget1750us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249-confirmed-worddiff" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget1750us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249-confirmed" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget1750us-lookupjit-limit1-arena-stack-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249-confirmed" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-confirmed-arena-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-confirmed-arena-nostack-noheap-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1000-arena-lite-changedjit" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1250-arena-lite-changedjit" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1250"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ACTOR_ARENA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
    ...
    "b1500-arena-lite-changedjit" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b2000-arena-lite-changedjit" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-poll100" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-maxcorr2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-postframe" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-rbwait100" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 100
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-skipresimcp" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-skipresimcp-final" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-audioskip" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-cp2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-appliedlead" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-appliedlead-skippred" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-mr1" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-mr2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-rbwait250" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 250
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-rbwait500" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 500
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-audioskip" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-consume" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-core27d-stack" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-core24d" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-core259" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-core269" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack-netrandom" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0xC80"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x02088800+0x300;0x021B5C00+0x400;0x021B6C00+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_CHANGED_PAGES = "1"
        }
    }
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-stack" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack-rbwait1000" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 1000
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack-rbwait2000" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 2000
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack-consume" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack-widearena" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr2-stack-heap15" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-consume" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-rbwait250" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 250
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-rbwait500" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 500
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-lead3" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-lead4" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-postframe" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1500-arena-lite-changedjit-cp2-cartlite-mr1-rd1" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 1
    ...
    "b1000-arena-lite-changedjit-cp2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-cp2-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-cp2-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1450-arena-lite-changedjit-cp2-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1450"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ACTOR_ARENA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
    ...
    "b1400-arena-lite-changedjit-cp2-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_STATE_SYNC_CONFIRMED_ONLY = "1"
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1400"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_ACTOR_ARENA_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
    ...
    "b1250-arena-lite-changedjit-cp2-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-rbwait250" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 250
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-rbwait500" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 500
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-skiprestorejit" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-prescratch2" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-prescratch3" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-consume" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-consume" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-lead1" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-arena-lite-changedjit-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1000-arena-lite-changedjit-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b500-arena-lite-changedjit-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1000-arena-lite-changedjit-lead1" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1250-arena-lite-changedjit-lead0" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-arena-lite-changedjit-lead1" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1000-arena-lite-changedjit-lead0-rbwait100" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 100
        RollbackMaxResimFrames = 4
    ...
    "b1000-arena-lite-changedjit-lead0-rbwait250" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 250
        RollbackMaxResimFrames = 4
    ...
    "b1750-mr2-confirmed-arena-nostack-noheap-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 2
    ...
    "b1750-mr3-confirmed-arena-nostack-noheap-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 3
    ...
    "b1750-rbwait250-confirmed-arena-nostack-noheap-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 250
        RollbackMaxResimFrames = 4
    ...
    "b1750-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_SAFE_OBJECT_FIELD_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_OBJECT_IDS_WITH_SAFE_RANGES = "0x0022,0x010C"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0xC80"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x021B5C00+0x400;0x021B6C00+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
    ...
    "b1750-poll100-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-resimdelay1-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-fullstar-player1000-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_OBJECT_IDS_WITH_SAFE_RANGES = "0x0022,0x010C"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0x1000"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x021B5C00+0x400;0x021B6C00+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
        }
    }
    "b1500-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1500-lead1-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1600-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1600"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
    ...
    "b1650-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1650"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
    ...
    "b1700-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1700"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
            MELONDS_NSML_ROLLBACK_JIT_LOOKUP_RESET_ONLY = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
    ...
    "b1000-fullstar-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "b1750-fullcollect-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_SAFE_OBJECT_FIELD_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_OBJECT_IDS_WITH_SAFE_RANGES = "0x0022,0x010C,0x001F"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0xC80"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x021B5C00+0x400;0x021B6C00+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
    ...
    "b1750-stack-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr8-lead2-budget500us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr8-lead2-budget1000us-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr8-lead2-budget500us-lookupjit-limit4-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core249" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-fullhazard-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_SAFE_OBJECT_FIELD_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FULL_OBJECT_IDS_WITH_SAFE_RANGES = "0x0053"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0xC80"
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer1000-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-prepump-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit4-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbcore-rb0-mr4-lead2-budget2ms-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
    ...
    "nsmbtc-rb0-mr8-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "trace-nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight-chaos990-1320" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_DELTA_PAGE_TRACE_END_FRAME = "1320"
            MELONDS_NSML_ROLLBACK_DELTA_PAGE_TRACE_MAX_RUNS = "80"
        }
    }
    "trace-b1750-input" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "probe-b1750-f962" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Extra = @{
            ...
            SkipMovementProbe = $true
            RollbackSettleFrames = 60
            RollbackPredictionProbeModulo = 600
            RollbackPredictionProbeOffset = 362
            RollbackPredictionProbeLimit = 1
            RollbackPredictionProbeStartFrame = 962
            RollbackPredictionProbeEndFrame = 962
            RollbackPredictionProbeKeyMask = "0x1"
        }
        Env = @{
            MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US = "1750"
            MELONDS_NSML_ROLLBACK_MAX_CORRECTIONS_PER_FRAME = "1"
    ...
    "probe-b1750-f910-962" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Extra = @{
            ...
            SkipMovementProbe = $true
            RollbackSettleFrames = 60
            RollbackPredictionProbeModulo = 52
            RollbackPredictionProbeOffset = 26
            RollbackPredictionProbeLimit = 2
            RollbackPredictionProbeStartFrame = 910
            RollbackPredictionProbeEndFrame = 962
            RollbackPredictionProbeKeyMask = "0x1"
        }
        Env = @{
    ...
    "nsmbtc-rb0-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra-leaks-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_PLAYER_OBJECT_LENGTH = "0xC80"
            MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES = "0x02089000+0x200;0x021B2C00+0x2000;0x021B5C00+0x400;0x021B6C00+0x400;0x02326000+0x400;0x0234A000+0x400"
            MELONDS_NSML_ROLLBACK_NSMB_DELTA_DISCOVERED_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_FORCE_JIT_RANGE_INVALIDATION = "1"
        }
    }
    "nsmbtc-rb500-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 500
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb1000-mr4-lead2-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 1000
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead0-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-core241" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead0-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap15-extra2p-delta-nojitrange" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead0-budget2ms-lookupjit-limit1-proclist-safe-fields-fullplayer-heap60-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead0-budget2ms-lookupjit-limit1-cp3-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead0-budget2ms-lookupjit-limit1-cp2-proclist-safe-fields-fullplayer-heap15-extra2p-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr8-lead6-budget2ms-lookupjit-limit1-proclist-safe-fields-heap15-delta-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-fixed-delta-playerc80-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-proclist-stack-delta-playerc80-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-arena-stack-heap15-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead4-budget2ms-lookupjit-limit1-arena-stack-heap15-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead3-budget2ms-lookupjit-limit1-arena-stack-heap15-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr4-lead6-budget2ms-lookupjit-limit1-widearena10000-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "nsmbtc-rb0-mr3-lead6-budget2ms-lookupjit-limit1-arena-stack-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 3
    ...
    "nsmbtc-rb0-mr3-lead6-budget2ms-lookupjit-limit1-arena-stack-heap15-devices-gpu3dlight" = [pscustomobject]@{
        Backend = "nsmbtinycore"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 3
    ...
    "jitlookup-compiledchunks-skiprestorejit-cp1-maxresim4-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 4
    ...
    "jitlookup-compiledchunks-skiprestorejit-cp1-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "jitlookup-compiledchunks-skiprestorejit-consume-cp1-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "jitlookup-compiledchunks-skiprestorejit-cp2-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "jitlookup-compiledchunks-skiprestorejit-adaptivecp2-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "jitlookup-compiledchunks-skiprestorejit-cp3-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "trace-jitlookup-compiledchunks-skiprestorejit-cp3-maxresim8-maxlead0-leadbudget2ms-chaos990-1320" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "trace-jitlookup-compiledchunks-skiprestorejit-cp3-maxresim8-maxlead0-leadbudget2ms-chaos2000-2220" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
        ...
        Env = @{
            ...
            MELONDS_NSML_ROLLBACK_SKIP_RESTORED_JIT_INVALIDATION = "1"
            MELONDS_NSML_ROLLBACK_DELTA_PAGE_TRACE = "1"
            MELONDS_NSML_ROLLBACK_DELTA_PAGE_TRACE_START_FRAME = "2000"
            MELONDS_NSML_ROLLBACK_DELTA_PAGE_TRACE_END_FRAME = "2220"
            MELONDS_NSML_ROLLBACK_DELTA_PAGE_TRACE_MAX_RUNS = "80"
            MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_RANGES = "1"
            MELONDS_NSML_ROLLBACK_NSMB_HEAP_SCAN_INTERVAL = "15"
    ...
    "jitlookup-compiledchunks-skiprestorejit-cp4-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
    ...
    "jitlookup-compiledchunks-skiprestorejit-cp8-maxresim8-maxlead0-leadbudget2ms" = [pscustomobject]@{
        Backend = "tinycoreramdelta"
        InputDelayFrames = 2
        RollbackInputWaitUs = 0
        RollbackMaxResimFrames = 8
...
$envKeys = @(
    ...
    "MELONDS_NSML_ROLLBACK_THROTTLE_PREDICTED_ONLY_WHEN_PENDING",
    "MELONDS_NSML_ROLLBACK_THROTTLE_APPLIED_FRAME_LEAD",
    "MELONDS_NSML_ROLLBACK_FRAME_LEAD_THROTTLE_BUDGET_US",
    "MELONDS_NSML_ROLLBACK_STARTUP_INPUT_WAIT_US",
    "MELONDS_NSML_ROLLBACK_STARTUP_INPUT_WAIT_FRAMES",
    ...
    "MELONDS_NSML_ROLLBACK_NSMB_PROCESS_LIST_METADATA_RANGES",
    ...
    "MELONDS_NSML_ROLLBACK_NSMB_FULL_PLAYER_OBJECT_WITH_SAFE_RANGES",
    "MELONDS_NSML_ROLLBACK_NSMB_FULL_OBJECT_IDS_WITH_SAFE_RANGES",
    "MELONDS_NSML_ROLLBACK_NSMB_EXTRA_RANGES",
    ...
    "MELONDS_NSML_INPUT_NETPLAY_TRACE",
    "MELONDS_NSML_STATE_SYNC_SAMPLE_WORD_DIFF",
    "MELONDS_NSML_STATE_APPLY_FRESH_WAIT_US",
    ...
    "MELONDS_NSML_WORLD_STATE_PRUNE_ABSENT_ACTOR_SNAPSHOT_STAR_CANDIDATE",
    "MELONDS_NSML_WORLD_STATE_SPAWN_ACTOR_SNAPSHOT_STAR_CANDIDATE",
    "MELONDS_NSML_WORLD_STATE_SPAWN_STAR_CANDIDATE",
    ...
    "MELONDS_NSML_WORLD_STATE_MOVING_HAZARD_PREDICT_BIAS_FRAMES",
    ...
    "MELONDS_NSML_WORLD_STATE_RELINK_MOVING_HAZARD_PROCESS_LISTS",
    "MELONDS_NSML_WORLD_STATE_CLEAR_MOVING_HAZARD_LINK_FIELDS",
    "MELONDS_NSML_WORLD_STATE_FREEZE_LOCAL_MOVING_HAZARD_UPDATE",
    "MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_MOVING_HAZARD",
    "MELONDS_NSML_WORLD_STATE_PRUNE_EXTRA_MOVING_HAZARD_DELAY_FRAMES",
    "MELONDS_NSML_WORLD_STATE_STAR_CANDIDATE_DEEP_SCAN_INTERVAL",
    "MELONDS_NSML_WORLD_STATE_STAR_CANDIDATE_FRESH_WAIT_US",
    "MELONDS_NSML_WORLD_STATE_PREFER_FRESH_SAMPLES",
    "MELONDS_NSML_WORLD_STATE_MOVING_HAZARD_PREFER_FRESH_SAMPLES",
    ...
    "MELONDS_NSML_PLAYER_STATE_RELIABLE_ON_GLOBAL_CHANGE",
    "MELONDS_NSML_PLAYER_STATE_RELIABLE_INTERVAL",
    "MELONDS_NSML_PLAYER_STATE_TREAT_TRANSITION_STATUS_LOCAL",
    "MELONDS_NSML_PLAYER_STATE_REAPPLY_OVERWRITTEN_GLOBALS",
    "MELONDS_NSML_PLAYER_STATE_REAPPLY_CRITICAL_GLOBALS_ONLY",
    "MELONDS_NSML_PLAYER_STATE_REAPPLY_DEATH_TRANSITION_GLOBALS_ONLY",
    "MELONDS_NSML_PLAYER_STATE_ZERO_PREDICT_DURING_TRANSITION",
    "MELONDS_NSML_PLAYER_STATE_FRESH_WAIT_US",
    "MELONDS_NSML_PLAYER_STATE_APPLY_TRACE",
    "MELONDS_NSML_PLAYER_STATE_APPLY_TRACE_START_FRAME",
    "MELONDS_NSML_PLAYER_STATE_APPLY_TRACE_END_FRAME",
    ...
    "MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM",
    "MELONDS_NSML_ROLLBACK_PRE_SCRATCH_RESIM_INTERVAL",
    "MELONDS_NSML_PERSISTENT_SHADOW_PROBE",
    "MELONDS_NSML_PERSISTENT_SHADOW_CONTINUOUS",
    "MELONDS_NSML_PERSISTENT_SHADOW_START_FRAME",
    "MELONDS_NSML_PERSISTENT_SHADOW_END_FRAME",
    "MELONDS_NSML_PERSISTENT_SHADOW_COMPARE_FRAME",
    "MELONDS_NSML_PERSISTENT_SHADOW_MAX_QUEUE",
    "MELONDS_NSML_PERSISTENT_SHADOW_SUMMARY_DRAIN_MS",
...
foreach ($candidateName in $Candidate) {
    ...
    foreach ($routeName in $Route) {
        ...
        $caseMatchSeed = if ($MvlMatchSeed.Length -gt 0) {
            $MvlMatchSeed
        } else {
            "practical-$candidateName-$routeName-$runStamp"
        }
        ...
        if ($PerfSpikePhaseTrace) {
            $params.PerfSpikePhaseTrace = $true
        }
        ...
        $hostPersistentShadow = Get-PersistentShadowFields -Path $hostStdout
        $clientPersistentShadow = Get-PersistentShadowFields -Path $clientStdout
        ...
        $summary.Add([pscustomobject]@{
            ...
            HostShadowEnqueued = $hostPersistentShadow.Enqueued
            ClientShadowEnqueued = $clientPersistentShadow.Enqueued
            HostShadowCompleted = $hostPersistentShadow.Completed
            ClientShadowCompleted = $clientPersistentShadow.Completed
            HostShadowDropped = $hostPersistentShadow.Dropped
            ClientShadowDropped = $clientPersistentShadow.Dropped
            HostShadowContinuous = $hostPersistentShadow.Continuous
            ClientShadowContinuous = $clientPersistentShadow.Continuous
            HostShadowContinuousInvalid = $hostPersistentShadow.ContinuousInvalid
            ClientShadowContinuousInvalid = $clientPersistentShadow.ContinuousInvalid
            HostShadowContinuityErrors = $hostPersistentShadow.ContinuityErrors
            ClientShadowContinuityErrors = $clientPersistentShadow.ContinuityErrors
            HostShadowLatestLag = $hostPersistentShadow.LatestLag
            ClientShadowLatestLag = $clientPersistentShadow.LatestLag
            HostShadowMaxLag = $hostPersistentShadow.MaxLag
            ClientShadowMaxLag = $clientPersistentShadow.MaxLag
            HostShadowEnqueueAvgUs = $hostPersistentShadow.EnqueueAvgUs
            ClientShadowEnqueueAvgUs = $clientPersistentShadow.EnqueueAvgUs
            HostShadowEnqueueMaxUs = $hostPersistentShadow.EnqueueMaxUs
            ClientShadowEnqueueMaxUs = $clientPersistentShadow.EnqueueMaxUs
            HostShadowRestoreAvgUs = $hostPersistentShadow.RestoreAvgUs
            ClientShadowRestoreAvgUs = $clientPersistentShadow.RestoreAvgUs
            HostShadowRestoreMaxUs = $hostPersistentShadow.RestoreMaxUs
            ClientShadowRestoreMaxUs = $clientPersistentShadow.RestoreMaxUs
            HostShadowRunAvgUs = $hostPersistentShadow.RunAvgUs
            ClientShadowRunAvgUs = $clientPersistentShadow.RunAvgUs
            HostShadowRunMaxUs = $hostPersistentShadow.RunMaxUs
            ClientShadowRunMaxUs = $clientPersistentShadow.RunMaxUs
            HostShadowCompared = $hostPersistentShadow.Compared
            ClientShadowCompared = $clientPersistentShadow.Compared
            HostShadowMatch = $hostPersistentShadow.Match
            ClientShadowMatch = $clientPersistentShadow.Match
            HostShadowDifferingBytes = $hostPersistentShadow.DifferingBytes
            ClientShadowDifferingBytes = $clientPersistentShadow.DifferingBytes
