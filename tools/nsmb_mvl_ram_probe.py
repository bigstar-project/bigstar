...
A2DJ_SYMBOLS = {
    ...
    "Net::packetSequencerSteps": 0x02088074,
    "Net::packetSequencerIDs": 0x02088078,
    "Net::packetSequencerBufCursors": 0x0208807C,
    "Net::packetFreeBytesSendBitmap": 0x02088080,
    "Net::packetSequencerBufLengths": 0x02088084,
...
A2DJ_FUNCTIONS = {
    ...
    "Net::Core::createPacketSequencer(u8**,u8,callback,void*)": 0x02010D0C,
    "Net::Core::readPacketInt(u16,u32)": 0x02010DAC,
    "Net::Core::readPacketByte(u16,u32)": 0x02010E14,
    "Net::Core::writePacketInt(u32,u32)": 0x02010E4C,
    "Net::Core::writePacketByte(u32,u8)": 0x02010E80,
    "Net::Core::freePacketBytes(u32,u32)": 0x02010E90,
    "Net::Core::allocPacketBytes(u32)": 0x02010EBC,
    "Net::Core::shareRandomSeed()": 0x02010F04,
    "Net::Core::processRecvPacket()": 0x02011360,
    "Net::Core::processSendPacket()": 0x02011428,
    "Net::Core::clearPacket()": 0x02011504,
    "Net::Core::initPacket()": 0x020115A8,
    "Net::PacketSequenceBuilder::nextByte()": 0x0201166C,
    "Net::PacketSequenceBuilder::pushPacket(u8,u8,const u8*)": 0x02011748,
}
