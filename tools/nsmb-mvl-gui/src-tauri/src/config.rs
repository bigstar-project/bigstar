...
pub(crate) const DEFAULT_SIGNAL_URL: &str =
    "wss://nsmb-mvl-signaling-insiders-signaling-prod.uniunitaro.workers.dev/session";
...
pub(crate) fn app_data_dir_name() -> &'static str {
    match option_env!("NSMB_MVL_APP_DATA_DIR_NAME") {
...
pub(crate) fn app_version() -> &'static str {
    match option_env!("NSMB_MVL_APP_VERSION") {
